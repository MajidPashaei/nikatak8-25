...
namespace Admin.Controllers
{
    ...
    public class GabzController : BaseController
    {
        ...
        new public IActionResult List()
        {
            ViewBag.List=db.Tbl_PayBills.Where(a=>a.User == User.Identity.GetId()).ToList();
            return View();
        }
        ...
        public IActionResult EstelamGabz (Vm_Gabz vg)
        {
            ...
            if (HttpContext.Session.GetInt32("sum") >= 200)
            {
                ...
                {
                    ViewBag.Msg=response.Content;  
                }
                return View();
            }
            else
            {
                ViewBag.Msg="موجودی کیف پول شما کافی نمی باشد";
                return View();
            }
        }
