...
namespace Admin.Controllers
{
    [Area("Admin")]
    [Authorize]
    public class EmdadController : BaseController
    {
        public EmdadController(ContextHampadco _db,IWebHostEnvironment env):base(_db,env)
        {
        ...
        {   var client = new RestClient("http://096440.com:8080/api/site/public/searchByChassisNumber");
            ...
            if (x.Settings.Success=="1")
            {
                ...
                HttpContext.Session.SetInt32("state", x.Data.Moshtarakyesno);
                HttpContext.Session.SetString("ChassisNumber", x.Data.ChassisNumber);
                HttpContext.Session.SetString("year", x.Data.BuildYear);
            }
        ...
        {
            ViewBag.state=Convert.ToString(HttpContext.Session.GetInt32("state"));
            ViewBag.ChassisNumber=HttpContext.Session.GetString("ChassisNumber");
        ...
        {
            HttpContext.Session.SetString("realOrLegal", vm_Emdad.realOrLegal);
            HttpContext.Session.SetString("kilometer", vm_Emdad.kilometer);
        ...
        public IActionResult Ostan(int id)
        {
            HttpContext.Session.SetInt32("idpak", id);
        ...
        {   
            HttpContext.Session.SetString("ostan", id);
            var client = new RestClient("https://096440.com/api/site/public/city/ops/show");
            client.Timeout = -1;
            var request = new RestRequest(Method.POST);
            request.AddHeader("Content-Type", "application/json");
            var body ="{\"filters\":[{\"field\":\"stateId\",\"type\":\"equal\",\"search\":\""+id+"\"}],\"sortOrders\":[{\"sortField\":\"cityName\",\"sortType\":\"asc\"}],\"pagination\":1,\"maxResults\":10000}";
            request.AddParameter("application/json", body,  ParameterType.RequestBody);
        ...
        public IActionResult Details(string id)
        {
            ...
            HttpContext.Session.SetString("City", id);
